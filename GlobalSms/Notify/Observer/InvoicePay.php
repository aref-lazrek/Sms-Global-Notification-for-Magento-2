...
namespace GlobalSms\Notify\Observer;

use Magento\Framework\Event\ObserverInterface;
use \Magento\Framework\Event\Observer       as Observer;
use \Magento\Framework\View\Element\Context as Context;
use \GlobalSms\Notify\Helper\Data                 as Helper;
/**
...
class InvoicePay implements ObserverInterface
{
    ...
    /**
     * Helper for GlobalSms Notify Module
     * @var \GlobalSms\Notify\Helper\Data
     */
    protected $_helper;
    ...
    public function execute(Observer $observer)
    {
        ...
        //Getting Username
        $this->username = $this->_helper->getGlobalSmsApiUsername();

        //Getting Password
        $this->password = $this->_helper->getGlobalSmsApiPassword();
